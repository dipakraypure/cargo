...
function filterme() {
	  ...
	  enqtable.fnFilter(origin, 0, true, false,true,false);
	  bktable.fnFilter(origin, 0, true, false,true,false);
	  ...
	  enqtable.fnFilter(destination, 1, true, false,false,false); 
	  bktable.fnFilter(destination, 1, true, false,false,false); 
	//build a filter string with an or(|) condition
	  ...
	  //now filter in column 2, with no regex, no smart filtering, no inputbox,not case sensitive
	  enqtable.fnFilter(forwarder, 2, true, false,false,false); 
	  bktable.fnFilter(forwarder, 2, true, false,false,false); 
	  ...
	  if( period != undefined){		  	  
		  ...
		  enqtable.fnFilter(dateRange, 3, true, false,false,false); 
		  bktable.fnFilter(dateRange, 3, true, false,false,false); 
	  }
