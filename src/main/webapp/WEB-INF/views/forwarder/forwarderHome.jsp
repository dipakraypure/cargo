...
#fwdlistTbl .table th {
    ...
    border-radius: 5px 5px 0px 0px;/*   background-color: #161a47;
    border-color: #161a47; */
}
#fwdlistTbl .dataTables_scrollBody, #fwdlistTbl .table.dataTable.no-footer {
    border-bottom: 1px solid #fff !important;
}
#fwdlistTbl .dataTables_wrapper {
    margin-top: 0px;
}
#fwdlistTbl .thead-dark {
}
a .img-box {
    width: auto;
    height: 100px;
		  	           ...
		  	           console.log(response)	  	 	        	
		  	            if(response.respCode == 1){  		    
		  	            	...
		  	            	for(var i=0 ; i< response.respData.length ; i++){  
		  	            	   var carriername = response.respData[i].carriername;
                               var carriershortname = response.respData[i].carriershortname;
                               var carrierWithShort = carriername+" ("+carriershortname+")";
                               var website = response.respData[i].website;
                               var logopath = response.respData[i].logopath;
                               var newDiv = '<a href="'+website+'" target="_blank"><div class="card">'+
                 				  '            <div class="img-box"><img class="card-img-top" src="'+logopath+'" alt="'+carriername+'"></div>'+
                				               '<div class="card-body">'+
                				                   '<h6 class="card-title text-truncate">'+carrierWithShort+'</h6>'+
                				               '</div>'+
                				            '</div></a>';

                               carrierDiv = carrierDiv + newDiv;
		  	            	}	
		  	            	
		  	            	$("#carrierListDiv").empty();
		  	                $("#carrierListDiv").append(carrierDiv);	            		             	       
		  	            }else{
  ...
  <div class="bg_white_main">
    <div class="row minht400 spl_padd">
      <div class="col-md-12 padd0">
        <h2 class="book_cargo_hd">My shortcut to make carrier bookings</h2>
      </div>
      <div class="col-md-12">
        <div class="bg_white31 row">
          <div class="col-md-8 col-xs-12">
            <div class="bg_white3 mb-0" id="carrierListDiv" style="height: 422px; overflow-x: auto;" >
            
				<!-- <div class="card">
				  <div class="img-box"><a href="http://www.aclcargo.com/" target="_blank"><img class="card-img-top" src="https://www.aclcargo.com/content/themes/acl/dist/assets/images/logos/footer-logo.png" alt="Atlantic Container Line"></a></div>
				  <div class="card-body">
				    <h6 class="card-title">Atlantic Container Line</h6>
				  </div>
				</div> -->
          ...
          <div class="col-md-4 col-xs-12">
            <div class="bg_white6">
              <div id="demo" class="carousel slide" data-ride="carousel"> 
                ...
                <!-- The slideshow -->
                <div class="carousel-inner" id="offerCarouselInnerId"></div>
