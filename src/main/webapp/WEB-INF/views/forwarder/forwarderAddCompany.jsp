...
<script type="text/javascript">
            ...
            $.post({
                ...
                success : function(response) {
     	          ...
     	          if(response.respCode == 1){
     		        ...
     		        window.location.href = contextPath+"/forwarderCompany";
    		          }else{
  ...
  function  loadExistingCompanyDetailsByUserId(userId){
	...
	window.pressedPAN = function(){
	    var a = document.getElementById('userPanFileId');
	...
	window.pressedIEC = function(){
	    var a = document.getElementById('userIECFileId');
	...
	window.pressedLOGO = function(){
	    var a = document.getElementById('logoFileId');
...
<div class="container-fluid">
  <div class="bg_white_main mb-4"> 
    ...
    <form method="post" id="company-update-form" >
      ...
      <div class="col-md-12">
        <button type="submit" value="Submit" class="comp_sub_btn float-right" style="display: block;"><span>Update</span></button>
      </div>
      <br>
    </form>
