...
$(function () {
  ...
  //user-verify-mobile-otp-form
  $('#user-verify-mobile-otp-form').submit(function (e) {
    e.preventDefault();
            ...
            <form method="post" id="user-profile-details-form" >
              ...
              <div class="row mt-4">
                ...
                <div class="col-md-4"> <span class="verified mt-1" id="veriSpanIdEmail" style="display: none;"><i class="fa fa-check" aria-hidden="true"></i> Verified </span>
                  ...
                  <span class="notverified mt-1" id="notVeriSpanIdEmail" style="display: none;"><i class="fa fa-times" aria-hidden="true"></i> Not Verified</span><a href="#" class="form-label-new marleft"  style="display: none;" id="verifyEmailOtpId">Verify Email</a> </div>
              </div>
              <div class="row mt-4">
                <div class="col-md-8">
                  <div class="row">
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" id="user-verify-mobile-otp-form" >
